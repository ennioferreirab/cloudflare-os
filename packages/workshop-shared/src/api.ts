 ...
 */
export const DEFAULT_SITE_NAME = "ScaleOS";
...
export type AdminSettingsView = {
  ...
  siteName: string;
  /** Custom deployment logo, or undefined to use the default ScaleOS mark. */
...
export interface AdminApi {
   ...
   * image, or undefined after reset. Pass null to restore the default ScaleOS mark. The
...
export type AiModelProvider =
  "openai" | "anthropic" | "google" | "openrouter" | "cloudflare" | "ollama";
